...
## Environments
- Preview: https://main--eds-site-one--kajaldesai16.hlx.page/
- Live: https://main--eds-site-one--kajaldesai16.hlx.live/
...
1. Open the `eds-site-one` directory in your favorite IDE and start coding :)
